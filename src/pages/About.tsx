...
const About = ({
    title = "About Us",
    description = "We are committed to secure and effortless digital wallet solutions that empower individuals and businesses to manage their finances with confidence.",
    mainImage = {
    ...
    achievementsDescription = "Delivering exceptional results and exceeding expectations.",
